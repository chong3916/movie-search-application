...
const WatchlistCard = ({listId, listName, privacy, haveRemoveListButton, handleWatchlistUpdate, setBanner}) => {
    return (
        <Card id={"watchlistCard-" + listName} className="bg-dark text-white" style={{minWidth: '16rem', height: '12rem', textAlign: "center", margin: "1%", padding: "2.5rem"}}>
            <Card.Body>
                <Card.Title><Link onClick={() => setBanner({message: null, variant: null})} className="WatchlistLink" aria-label={listName} id={"watchlistCardLink-" + listName}
