...
import static edu.usc.csci310.project.demo.steps.NavigationBarStepDefinitions.navbarGetDriver;
...
public class WatchlistStepDefinitions {
    ...
    @Before
    public void before() {
        driver = navbarGetDriver(); // Get same driver from navigation bar step def
    }
